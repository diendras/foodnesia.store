...
<head>
    ...
    <title>Databaseque.com</title> 
    <link rel="shortcut icon" type="image/x-icon" href="images/logo/1/1b.png">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+6281381767080"><i class="fa fa-phone"></i> +6281381767080</a></li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i>Location</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+6281381767080"><i class="fa fa-phone"></i>
                                    +6281381767080</a></li>
                            <li class="text-right"><a href="https://wa.me/message/SNSNJMR5J35SP1"><i
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">    
                    ...
                    <li> <a href="{{route('shopping7')}}">History</a>
                    </li>

                    <li> <a href="{{route('shopping5')}}">Booking</a>
                    ...
                    @if(Route::has('login'))
                        @auth
                            ...
                            @elseif(Auth::user()->utype==='SVP')
                                ...
                                <li class="login-form"> <a href="#" title="Register">{{ Auth::user()->name }} ( Provider )</a>
                                    <ul class="drop-down one-column hover-fade">
                            ...
                            @else
                                <!--Customer links-->
                                <li class="login-form"> <a href="#" title="Register">{{ Auth::user()->name }} ( Customer ) </a>
                                    <ul class="drop-down one-column hover-fade">
