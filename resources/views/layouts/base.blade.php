...
<head>
    <meta charset="utf-8">
    <title>GreenHouse - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+211234567890"><i class="fa fa-phone"></i> +21-1234567890</a></li>
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                                    contact@greenhouse.in</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+211234567890"><i class="fa fa-phone"></i>
                                    +21-1234567890</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> SSC Jakarta</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> SSC, Jakarta</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    @if(Route::has('login'))
                        @auth
                            ...
                            @elseif(Auth::user()->utype==='SVP')
                                ...
                                <li class="login-form"> <a href="#" title="Register">My Account(SProvider)</a>
                                    <ul class="drop-down one-column hover-fade">
